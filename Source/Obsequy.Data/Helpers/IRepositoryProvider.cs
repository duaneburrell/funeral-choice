...
namespace Obsequy.Data
{
    ...
    public interface IRepositoryProvider
    {
        ...
        /// </typeparam>
        MongoRepository.IRepository<T> GetRepositoryForEntityType<T>() where T : MongoRepository.IEntity;
        ...
        /// </remarks>
        //MongoRepository.IRepository<T> GetRepository<T>(Func<object> factory = null) where T : MongoRepository.IEntity;
        T GetRepository<T>(Func<object> factory = null) where T : class;
