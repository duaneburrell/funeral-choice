...
namespace Obsequy.Data
{
    ...
    public class RepositoryFactories
    {
        ...
        /// </remarks>
        private IDictionary<Type, Func<object>> GetFactories()
        {
            return new Dictionary<Type, Func<object>>
                {
                   {typeof(IAdministratorsRepository), () => new AdministratorsRepository()},
                   {typeof(IConsumerPortfoliosRepository), () => new ConsumerPortfoliosRepository()},
                   {typeof(IConsumerMembersRepository), () => new ConsumerMembersRepository()},
                   {typeof(IProviderPortfoliosRepository), () => new ProviderPortfoliosRepository()},
                   {typeof(IProviderMembersRepository), () => new ProviderMembersRepository()},
				   {typeof(IResponsesRepository), () => new ResponsesRepository()}
                };
        }
        ...
        /// </remarks>
        public RepositoryFactories(IDictionary<Type, Func<object>> factories )
        {
        ...
        /// </remarks>
        public Func<object> GetRepositoryFactory<T>()
        {
        ...
        /// </remarks>
        public Func<object> GetRepositoryFactoryForEntityType<T>() where T : MongoRepository.IEntity
        {
        ...
        protected virtual Func<object> DefaultEntityRepositoryFactory<T>() where T : MongoRepository.IEntity
        {
            return () => new MongoRepository.MongoRepository<T>();
        }
