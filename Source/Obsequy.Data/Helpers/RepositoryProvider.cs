...
namespace Obsequy.Data
{
    ...
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        /// </remarks>
        public MongoRepository.IRepository<T> GetRepositoryForEntityType<T>() where T : MongoRepository.IEntity
        {
            var factory = _repositoryFactories.GetRepositoryFactoryForEntityType<T>();
            // Look for T dictionary cache under typeof(T).
            object repoObj;
            Repositories.TryGetValue(typeof(T), out repoObj);
            if (repoObj != null)
            {
                return (MongoRepository.IRepository<T>)repoObj;
            }

            // Not found or null; make one, add to dictionary cache, and return it.
            return MakeRepository<MongoRepository.IRepository<T>>(factory);
        }
        ...
        /// </remarks>
        public T GetRepository<T>(Func<object> factory = null) where T : class
        {
            // Look for T dictionary cache under typeof(T).
            object repoObj;
            Repositories.TryGetValue(typeof(T), out repoObj);
        ...
        //public virtual MongoRepository.IRepository<T> GetRepository<T>(Func<object> factory = null) where T : MongoRepository.IEntity
        //{
        //    // Look for T dictionary cache under typeof(T).
        //    object repoObj;
        //    Repositories.TryGetValue(typeof(T), out repoObj);
        ...
        /// </param>
        /// <returns></returns>
        protected virtual T MakeRepository<T>(Func<object> factory)
        {
